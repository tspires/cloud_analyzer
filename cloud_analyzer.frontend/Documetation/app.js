    ...
    class AppMenu extends HTMLElement {
      connectedCallback() {
        ...
        <a href="index.html" class="shrink h-16 flex items-center justify-center border-b border-dashed border-gray-200">
          ...
          <p class="text-lg font-medium">Rasket - Vue</p>
          </div>
        </a>
        <div class="grow">
    ...
    class AppFooter extends HTMLElement {
      connectedCallback() {
        ...
        <div class="flex md:justify-between justify-center w-full gap-4">
          <div>
            ${new Date().getFullYear()} © Rasket - Vue - <a href="#">Techzaa</a>
          </div>
          <div class="md:flex hidden gap-4 item-center md:justify-end">
            <a href="#" class="text-sm leading-5 text-zinc-600 transition hover:text-zinc-900">About</a>
            <span class="border-e border-gray-300 "></span>
            <a href="#" class="text-sm leading-5 text-zinc-600 transition hover:text-zinc-900">Support</a>
            <span class="border-e border-gray-300 "></span>
            <a href="#" class="text-sm leading-5 text-zinc-600 transition hover:text-zinc-900">Contact Us</a>
          </div>
        </div>
      </footer>`
      }
